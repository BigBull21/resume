...
\mySubHeadingListStart
  ...
  {\faIcon{building} NASA, National Aeronautics and Space Administration
    ...
    \myItemListStart
      \myItem{Developed script automating the auditing of requirement traceability in JAMA.}
      \myItem{Guided subsystem team in crafting comprehensive requirement closure plans.}
      \myItem{Designed and tailored new and existing DVOs (Design Verification Objectives) to meet emerging Program needs.}
      \myItem{Enhanced requirement traceability by teaming up with subsystem experts to improve clarity and consistency in 3 ICDs (Interface Control Documents).}
    \myItemListEnd
